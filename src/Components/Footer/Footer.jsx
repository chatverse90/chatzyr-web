                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                ...
                                <div className="footer-content">
                                    <p>
                                        Chatzyr is a revolutionary mobile application featuring social connections, direct messages, group chats, and group streams. Connect, chat, and stream together with friends and communities.
                                    </p>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="single-footer-widget">
                                <div className="contact-box">
                                    ...
                                    <div className="text">Download Chatzyr today and start connecting with friends through secure messaging, group chats, and live streaming.
                                    </div>
                                    <div className="info">
                                        <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="23"
                                                ...
                                                <path
                                                    ...
                                                    stroke="rgb(19, 70, 134)" strokeWidth="2" strokeLinecap="round"
                                                    strokeLinejoin="round" />
                                                <path d="M20.1667 6L11 12.4167L1.83337 6" stroke="rgb(19, 70, 134)" strokeWidth="2"
                                                    strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </div>
                                        <div className="link">
                                            <a href="mailto:info@chatzyr.com">info@chatzyr.com</a> <br/>
                                            <a href="mailto:support@chatzyr.com">support@chatzyr.com</a>
                                        </div>
                                    </div>
                                    <div className="info">
                                        <div className="icon">
                                        ...
                                        <div className="link">
                                            <a href="tel:+1-555-CHATZYR">+1-555-CHATZYR</a> <br/>
                                            <a href="tel:+1-555-424-2897">+1-555-424-2897</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
