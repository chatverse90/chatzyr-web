        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Have questions about Chatzyr? We'd love to hear from you. 
            ...
            <div className="contact-info-section">
              <div className="info-header">
                ...
                <p className="info-subtitle">
                  Prefer to reach out directly? Here are other ways to get in touch.
                </p>
              </div>
              ...
              <div className="contact-methods">
                <div className="contact-method">
                  ...
                  <div className="method-content">
                    ...
                    <a href="mailto:hello@chatzyr.com" className="method-link">hello@chatzyr.com</a>
                  </div>
                </div>
                ...
                <div className="contact-method">
                  ...
                  <div className="method-content">
                    ...
                    <p className="method-description">Mon-Fri from 9am to 6pm</p>
                ...
                <div className="contact-method">
                  ...
                  <div className="method-content">
                    ...
                    <p className="method-description">Come say hello at our office</p>
                    <span className="method-link">123 Innovation Street<br />Tech City, TC 12345</span>
                  </div>
                </div>
              </div>
